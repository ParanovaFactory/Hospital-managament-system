...
namespace Hastane_Yönetim_Ve_Randevu_Sistemi
{
    public partial class FrmHastaBilgiDüzenle : Form
    {
        ...
        {
            SqlCommand komut2 = new SqlCommand("update Tbl_Hastalar set HastaAd=@p1,HastaSoyad=@p2,HastaTelefon=@p3,HastaSifre=@p4,HastaCinsiyet=@p5,HastaTel=@p7 where HastaTC=@p6", bgl.baglanti());
            ...
            komut2.Parameters.AddWithValue("@p7", MskTelefon.Text);
